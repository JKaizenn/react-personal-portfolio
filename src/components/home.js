            ...
            <main>
                ...
                <section className="project-images">
                    ...
                    <div className="image-container">
                        <img src={`${process.env.PUBLIC_URL}/images/Homepage.png`} alt="Homepage" loading="lazy" />
                        <img src={`${process.env.PUBLIC_URL}/images/Temples.png`} alt="Temples" loading="lazy" />
                        <img src={`${process.env.PUBLIC_URL}/images/Filtered-Temples.png`} alt="Filtered Temples" loading="lazy" />
                    </div>
                </section>
